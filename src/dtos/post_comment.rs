...
impl PostCommentDTO {
  ...
  pub fn set_commmented_post_owner_id(&mut self, v: Uuid) -> &mut Self {
    self.commented_post_owner_id = v;
    self
  }

  pub fn set_commented_post_created_at(&mut self, v: DateTimeWithTimeZone) -> &mut Self {
    self.commented_post_created_at = v;
    self
  }
